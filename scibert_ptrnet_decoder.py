...
if __name__ == "__main__":
    ...
    if not os.path.exists('/content/drive/My Drive/New_dataset/SciBERT_output'):
        os.mkdir('/content/drive/My Drive/New_dataset/SciBERT_output')
    model_name = 1
    job_mode = sys.argv[3]
    ...
    bert_tokenizer = AutoTokenizer.from_pretrained(bert_model_name, do_lower_case=True, model_max_length=512)
    ...
    # train a model
    if job_mode == 'train':
        logger = open(os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/training.log'), 'w')
        ...
        model_file_name = os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/model.h5py')
        ...
        save_vocab = os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/vocab.pkl')
    ...
    if job_mode == 'test':
        logger = open(os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/test.log'), 'w')
        custom_print(sys.argv)
        custom_print("loading word vectors......")
        vocab_file_name = os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/vocab.pkl')
        ...
        model_file = os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/model.h5py')
        ...
        write_test_res(src_test_file, test_data, test_preds,
                       os.path.join('/content/drive/My Drive/New_dataset/SciBERT_output/test.out'))
